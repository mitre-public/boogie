...
/**
 * Immutable contents of a DAFIF 8.1 BDRY.TXT record.
 */
public final class DafifBoundarySegment implements DafifModel {
  ...
  public DafifBoundarySegment(Builder builder) {
  ...
  public DafifFileType getFileType() {
    return DafifFileType.BOUNDARY_SEGMENT;
  }
  ...
  public boolean equals(Object o) {
    ...
    DafifBoundarySegment that = (DafifBoundarySegment) o;
  ...
  public static final class Builder {
    ...
    public DafifBoundarySegment build() {
      return new DafifBoundarySegment(this);
    }
  }
}

...
public class DafifRunwayValidator implements Predicate<DafifRecord> {
  ...
  public boolean test(DafifRecord dafifRecord) {
    return dafifRecord.recordType().equals(DafifRecordType.RWY)
        ...
        && containsParsedField(dafifRecord, "highEndGeodeticLatitude", missingFieldConsumer)
        && containsParsedField(dafifRecord, "highEndDegreesLatitude", missingFieldConsumer)
        && containsParsedField(dafifRecord, "highEndGeodeticLongitude", missingFieldConsumer)
        && containsParsedField(dafifRecord, "highEndDegreesLongitude", missingFieldConsumer)
        && containsParsedField(dafifRecord, "lowEndGeodeticLatitude", missingFieldConsumer)
        && containsParsedField(dafifRecord, "lowEndDegreesLatitude", missingFieldConsumer)
        && containsParsedField(dafifRecord, "lowEndGeodeticLongitude", missingFieldConsumer)
        && containsParsedField(dafifRecord, "lowEndDegreesLongitude", missingFieldConsumer)

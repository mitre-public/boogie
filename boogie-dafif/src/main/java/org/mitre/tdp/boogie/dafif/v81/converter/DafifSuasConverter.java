...
public final class DafifSuasConverter implements Function<DafifRecord, Optional<DafifSuasSegment>> {

  @Override
  public Optional<DafifSuasSegment> apply(DafifRecord record) {
    requireNonNull(record, "Cannot convert null DafifRecord.");

    return Optional.of(DafifSuasSegment.builder()

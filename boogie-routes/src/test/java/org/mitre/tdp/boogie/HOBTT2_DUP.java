...
public class HOBTT2_DUP implements Procedure {
  public static final HOBTT2_DUP INSTANCE = new HOBTT2_DUP();
  private final List<Transition> transitions;

  private HOBTT2_DUP() {
    this.transitions = List.of(DRSDN(), KHMYA(), COOUP(), BEORN(), FRDDO(), ENNTT(), ORRKK(),
        GOLLM(), STRDR(), SHYRE(), COMMON(), RW26B(), RW27B(), RW27B_DUP(), RW28(), RW28_CD());
  }
  ...
  private static Transition COMMON() {
    ...
    return Transition.builder()
        ...
        .categoryOrTypes(Set.of(CategoryOrType.JET, CategoryOrType.TURBOJET, CategoryOrType.PROP, CategoryOrType.TURBOPROP))
        .legs(List.of(HOBTT, ENSLL))
        .build();
  }
  ...
  private static Transition RW27B() {
    ...
    return Transition.builder()
        .transitionIdentifier("RW27B")
        .transitionType(TransitionType.RUNWAY)
        .categoryOrTypes(Set.of(CategoryOrType.JET, CategoryOrType.TURBOJET))
        .legs(Arrays.asList(ENSLL, EAGYL, SHURT, FOGER, HITTT, YURII, YURII2))
        .build();
  }

  //this one is actually less points to just double check we get what we want here
  private static Transition RW27B_DUP() {
    Leg ENSLL = IF("ENSLL", 33.31919166666667, -84.83804444444444);
    Leg EAGYL = TF("EAGYL", 33.536791666666666, -84.58458333333333);
    Leg YURII = TF("YURII", 33.53713055555556, -84.03544166666667);
    Leg YURII2 = FM("YURII", 33.53713055555556, -84.03544166666667);
    return Transition.builder()
        .transitionIdentifier("RW27B")
        .transitionType(TransitionType.RUNWAY)
        .categoryOrTypes(Set.of(CategoryOrType.PROP, CategoryOrType.TURBOPROP, CategoryOrType.CAT_C)) //the c is there just for test purposes
        .legs(Arrays.asList(ENSLL, EAGYL, YURII, YURII2))
        .build();
  }
  ...
  private static Transition RW28() {
    ...
    Leg YURII = TF("YURII", 33.53713055555556, -84.03544166666667);
    Leg YURII2 = FM("YURII", 33.53713055555556, -84.03544166666667);
    List<Leg> legs = List.of(ENSLL, EAGYL, SHURT, FOGER, HITTT, YURII, YURII2);
    Set<CategoryOrType> types = Set.of(CategoryOrType.PROP, CategoryOrType.TURBOPROP);
    return Transition.builder()
        .legs(legs)
        .transitionIdentifier("RW28")
        .categoryOrTypes(types)
        .transitionType(TransitionType.RUNWAY)
        .build();
  }

  private static Transition RW28_CD() {
    Leg ENSLL = IF("ENSLL", 33.31919166666667, -84.83804444444444);
    Leg EAGYL = TF("EAGYL", 33.536791666666666, -84.58458333333333);
    Leg SHURT = TF("SHURT", 33.53684166666667, -84.43048055555556);
    Leg FOGER = TF("FOGER", 33.53689166666666, -84.30732777777777);

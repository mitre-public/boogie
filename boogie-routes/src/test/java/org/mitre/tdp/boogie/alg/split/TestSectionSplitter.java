...
public class TestSectionSplitter {
  ...
  public void testRoute0_0() {
    List<SectionSplit> splits = SectionSplitter.splits(ROUTE0.get(0));
  ...
  public void testRoute0_1() {
    List<SectionSplit> splits = SectionSplitter.splits(ROUTE0.get(2));
  ...
  public void testRoute1_0() {
    List<SectionSplit> splits = SectionSplitter.splits(ROUTE1.get(0));
  ...
  public void testRoute2_0() {
    List<SectionSplit> splits = SectionSplitter.splits(ROUTE2.get(0));
  ...
  public void testRoute3_0() {
    List<SectionSplit> splits = SectionSplitter.splits(ROUTE3.get(0));

...
public class KMCO_I17L implements Procedure{
  ...
  private static Transition ALL() {
    ...
    Leg RW17L = CF("RW17L", 28.43561111111111, -81.29588055555556);
    return transition("ALL", "I17L", "KMCO", TransitionType.COMMON, ProcedureType.APPROACH,
        Arrays.asList(SACRO, TACOT, DALTY, ELLAN, GLOSI, MINCO, RW17L));
  }
  ...
  private static Transition MISSED() {
    ...
    return transition("MISSED", "I17L", "KMCO", TransitionType.MISSED, ProcedureType.APPROACH,
  ...
  private static Transition RATOY() {
    ...
    return transition("RATOY", "I17L", "KMCO", TransitionType.APPROACH, ProcedureType.APPROACH,

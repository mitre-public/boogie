...
class StarGrapherTest {
  ...
  private static ProcedureGraph nominalGraph(ProcedureType type) {
    ...
    Transition ab = transition("B", "ALPHA1", "APT", TransitionType.ENROUTE, type, Arrays.asList(l1_1, l1_2));
    ...
    Transition cd = transition("D", "ALPHA1", "APT", TransitionType.RUNWAY, type, Arrays.asList(l3_1, l3_2));

...
public final class LegMergerFactory {
  ...
  public static LeftMerger<ResolvedLeg> newSimilarSubsequentGraphableLegMerger() {
   ...
   * of the TF leg version is actually incorrect in the context of how HOBBT was reached in the final routing.
   */

...
public final class LatLonToken implements ResolvedToken {
  ...
  private LatLonToken(Fix fix, String wildcards) {
   ...
   */
  public static LatLonToken from(RouteToken sectionSplit) {
    ...
    return new LatLonToken(fix, RouteTokenVisitor.wildcards(sectionSplit));
  }

...
class FlatStationDeclinationConverterTest {
  ...
  void convertsWestStationDeclination() {
    ...
    sd.setStationDeclinationEWT(org.mitre.boogie.xml.v23_5.generated.StationDeclinationEWT.WEST);
  ...
  void convertsEastStationDeclination() {
    StationDeclination sd = new StationDeclination();
    sd.setStationDeclinationEWT(org.mitre.boogie.xml.v23_5.generated.StationDeclinationEWT.EAST);
  ...
  void trueStationDeclinationReturnsNull() {
    StationDeclination sd = new StationDeclination();
    sd.setStationDeclinationEWT(org.mitre.boogie.xml.v23_5.generated.StationDeclinationEWT.TRUE);

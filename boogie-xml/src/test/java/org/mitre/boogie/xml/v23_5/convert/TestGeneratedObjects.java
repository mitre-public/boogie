...
import org.mitre.boogie.xml.v23_5.generated.*;
...
final class TestGeneratedObjects {
  ...
  static Frequency newFrequency(double value, org.mitre.boogie.xml.v23_5.generated.FreqUnitOfMeasure unit) {
  ...
  static Vor newValidVor() {
    ...
    vor.setVorFrequency(newFrequency(113.1, org.mitre.boogie.xml.v23_5.generated.FreqUnitOfMeasure.MEGA_HERTZ));
  ...
  static Dme newValidDme() {
    ...
    dme.setFrequency(newFrequency(110.3, org.mitre.boogie.xml.v23_5.generated.FreqUnitOfMeasure.MEGA_HERTZ));
  ...
  static Tacan newValidTacan() {
    ...
    tacan.setFrequency(newFrequency(112.0, org.mitre.boogie.xml.v23_5.generated.FreqUnitOfMeasure.MEGA_HERTZ));
  ...
  static MilitaryTacan newValidMilitaryTacan() {
    ...
    tacan.setFrequency(newFrequency(114.0, org.mitre.boogie.xml.v23_5.generated.FreqUnitOfMeasure.MEGA_HERTZ));
  ...
  static Ndb newValidNdb() {
    ...
    ndb.setNdbFrequency(newFrequency(382.0, org.mitre.boogie.xml.v23_5.generated.FreqUnitOfMeasure.KILO_HERTZ));
    NdbNavaidClass ndbClass = new NdbNavaidClass();
    ndbClass.setIsBfoRequired(false);
    ndbClass.setNdbNavaidCoverage(org.mitre.boogie.xml.v23_5.generated.NdbNavaidCoverage.HIGH_POWER_NDB);
    ndbClass.setNdbNavaidIfMarker(NdbNavaidIfMarkerInfo.OUTER_MARKER);
    ndbClass.setNdbNavaidType(org.mitre.boogie.xml.v23_5.generated.NdbNavaidType.NDB);
  ...
  static PortCommunication newValidPortCommunication() {
    ...
    comm.setTransmitFrequency(newFrequency(120.75, org.mitre.boogie.xml.v23_5.generated.FreqUnitOfMeasure.MEGA_HERTZ));
    comm.setReceiveFrequency(newFrequency(120.75, org.mitre.boogie.xml.v23_5.generated.FreqUnitOfMeasure.MEGA_HERTZ));
  ...
  static LocalizerGlideslope newValidLocalizerGlideslope() {
    ...
    lg.setLocalizerGlideslopeFrequency(newFrequency(110.3, org.mitre.boogie.xml.v23_5.generated.FreqUnitOfMeasure.MEGA_HERTZ));
  ...
  static AirportHeliportLocalizerMarker newValidLocalizerMarker() {
    ...
    marker.setLocatorFrequency(newFrequency(350.0, org.mitre.boogie.xml.v23_5.generated.FreqUnitOfMeasure.KILO_HERTZ));

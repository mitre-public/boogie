...
import org.mitre.boogie.xml.v23_5.generated.Port;
...
final class ArincPortConverter implements Function<Port, ArincPortInfo> {
  ...
  public ArincPortInfo apply(Port port) {
    ...
    UtcOffset offset = Optional.ofNullable(port.getUtcOffset())
        .filter(org.mitre.boogie.xml.v23_5.generated.UtcOffset::isIsDaylightObserving)
        .map(org.mitre.boogie.xml.v23_5.generated.UtcOffset::getTimeZone)
  ...
  private List<ArincProcedure> convertProcedures(org.mitre.boogie.xml.v23_5.generated.TerminalProcedures tp) {
    return Stream.of(
            tp.getSid().stream().map(s -> (org.mitre.boogie.xml.v23_5.generated.Procedure) s),
            tp.getStar().stream().map(s -> (org.mitre.boogie.xml.v23_5.generated.Procedure) s),
            tp.getApproach().stream().map(s -> (org.mitre.boogie.xml.v23_5.generated.Procedure) s))

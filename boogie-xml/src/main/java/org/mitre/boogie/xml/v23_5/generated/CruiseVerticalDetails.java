 ...
 *         &lt;element name="cruiseLevelTo" type="{http://www.arinc424.com/xml/datatypes}CruiseLevelTo"/&gt;
...
public class CruiseVerticalDetails {
    ...
    @XmlElement(required = true)
    protected CruiseLevelTo cruiseLevelTo;
    @XmlElement(required = true)
     ...
     *     
     */
    public CruiseLevelTo getCruiseLevelTo() {
     ...
     *     
     */
    public void setCruiseLevelTo(CruiseLevelTo value) {

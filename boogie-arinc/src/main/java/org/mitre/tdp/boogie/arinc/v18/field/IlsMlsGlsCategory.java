 ...
 * and does not limit minimal using designated classification.
 * <br>
 * This field is also used to define the classification, non-ILS/MLS/GLS, and localizer installation such as IGS, LDA, or SDF.
 * <br>
 * As used in the runway record, there are two fields, one labeled Localizer/MLS/GLS Category/Classification and the other labeled
 * Second Localizer/MLS/GLS Category/Classification.
 */

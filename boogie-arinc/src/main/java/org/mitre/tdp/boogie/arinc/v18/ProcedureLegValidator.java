...
public final class ProcedureLegValidator implements Predicate<ArincRecord> {
  ...
  private static final String TURN_DIRECTION = "turnDirection";

  private static final String OUTBOUND_MAGNETIC_COURSE = "outboundMagneticCourse";

  private static final String ROUTE_HOLD_DISTANCE_TIME = "routeHoldDistanceTime";
  ...
  private ImmutableMap<PathTerminator, Predicate<ArincRecord>> legValidators() {
    return ImmutableMap.<PathTerminator, Predicate<ArincRecord>>builder()
        ...
        .put(PathTerminator.CF, arincRecord -> containsAssociatedFixFields(arincRecord)
            ...
            && containsParsedField(arincRecord, OUTBOUND_MAGNETIC_COURSE, missingFieldConsumer)
            && containsParsedField(arincRecord, ROUTE_HOLD_DISTANCE_TIME, missingFieldConsumer))
        ...
        .put(PathTerminator.FM, arincRecord -> containsAssociatedFixFields(arincRecord)
            ...
            && containsParsedField(arincRecord, RHO, missingFieldConsumer)
            && containsParsedField(arincRecord, OUTBOUND_MAGNETIC_COURSE, missingFieldConsumer))
        .put(PathTerminator.CA, arincRecord -> containsParsedField(arincRecord, OUTBOUND_MAGNETIC_COURSE, missingFieldConsumer))
        .put(PathTerminator.CD, arincRecord -> containsRecommendedNavaidFields(arincRecord)
            && containsParsedField(arincRecord, OUTBOUND_MAGNETIC_COURSE, missingFieldConsumer)
            && containsParsedField(arincRecord, ROUTE_HOLD_DISTANCE_TIME, missingFieldConsumer))
        .put(PathTerminator.CI, arincRecord -> containsParsedField(arincRecord, OUTBOUND_MAGNETIC_COURSE, missingFieldConsumer))
        ...
        .put(PathTerminator.RF, arincRecord -> containsAssociatedFixFields(arincRecord)
            ...
            && containsParsedField(arincRecord, TURN_DIRECTION, missingFieldConsumer)
            && containsParsedField(arincRecord, ROUTE_HOLD_DISTANCE_TIME, missingFieldConsumer))
        ...
        .put(PathTerminator.VD, arincRecord -> containsRecommendedNavaidFields(arincRecord)
            && containsParsedField(arincRecord, OUTBOUND_MAGNETIC_COURSE, missingFieldConsumer)
            && containsParsedField(arincRecord, ROUTE_HOLD_DISTANCE_TIME, missingFieldConsumer))
        .put(PathTerminator.VI, arincRecord -> containsParsedField(arincRecord, OUTBOUND_MAGNETIC_COURSE, missingFieldConsumer))
        .put(PathTerminator.VM, arincRecord -> containsParsedField(arincRecord, OUTBOUND_MAGNETIC_COURSE, missingFieldConsumer))

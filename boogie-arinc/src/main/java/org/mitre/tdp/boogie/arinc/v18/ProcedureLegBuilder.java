...
public final class ProcedureLegBuilder implements Function<ArincRecord, ArincProcedureLeg.Builder> {
  public static final ProcedureLegBuilder INSTANCE = new ProcedureLegBuilder();
  private ProcedureLegBuilder() {}
  @Override
  public ArincProcedureLeg.Builder apply(ArincRecord arincRecord) {

 ...
 */
public final class ArincParser implements Function<String, Optional<ArincRecord>> {

  private static final Logger LOG = LoggerFactory.getLogger(ArincParser.class);
  ...
  /**
   * Supplied for easier instantiation of the parser.
   */
  public ArincParser(RecordSpec... recordSpecs) {
    this(ImmutableList.copyOf(recordSpecs));
  }

  public ArincParser(List<RecordSpec> recordSpecs) {

...
2. ```java -jar -Xmx5120m boogie-arinc-<version>-all.jar``` - to run the mainClass from the jar i.e. the server start script. That's also around the recommended heap memory settings for the default

...
public final class WeightFunctions {
   ...
   */
  public static Function<Double, Double> simpleLinear(double x1, double y1) {
   ...
   */
  public static Function<Double, Double> linearBetween(double x0, double y0, double x1, double y1) {
    return d -> {
      if (d > x0 && d < x1) {
